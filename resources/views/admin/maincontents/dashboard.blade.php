          ...
          <div class="card-body">
            ...
            <ul class="list-group list-group-flush list-group-no-gutters">
              ...
              <li class="list-group-item">
                <div class="d-flex">
                  <div class="flex-shrink-0">
                    <img class="avatar avatar-xs avatar-4x3" src="<?=env('ADMIN_ASSETS_URL')?>assets/svg/brands/capsule-icon.svg" alt="Image Description">
                  </div>
              ...
              <li class="list-group-item">
                <div class="d-flex">
                  <div class="flex-shrink-0">
                    <img class="avatar avatar-xs avatar-4x3" src="<?=env('ADMIN_ASSETS_URL')?>assets/svg/brands/mailchimp-icon.svg" alt="Image Description">
                  </div>
                  <div class="flex-grow-1 ms-3">
                    <div class="row align-items-center">
                      <div class="col">
            ...
            <tr>
              ...
              <td class="table-column-ps-0">
                <a class="d-flex align-items-center" href="user-profile.html">
                  <div class="flex-shrink-0">
                    <div class="avatar avatar-sm avatar-circle">
                      <img class="avatar-img" src="<?=env('ADMIN_ASSETS_URL')?>assets/img/160x160/img4.jpg" alt="Image Description">
                    </div>
                  </div>
                  <div class="flex-grow-1 ms-3">
