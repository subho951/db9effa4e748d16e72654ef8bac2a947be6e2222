                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="<?=url('admin/billing/billing-item/' . Helper::encoded($row->id))?>"><button class="btn btn-custom">SELECT</button></a></td>
                        </tr>
                    <?php } } else {?>
                        <tr>
                            <td colspan="9" style="color: red !important; text-align: center;">No ongoing orders found</td>
                        </tr>
                    <?php }?>
                </tbody>
            </table>
