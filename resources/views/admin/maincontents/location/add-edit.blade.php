        ...
        <div class="card-body">
          ...
          <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="mb-3 col-md-6">
                 <label for="details" class="form-label">Details <small class="text-danger">*</small></label>
                 <textarea class="form-control" id="details" name="details" rows="5" required><?=$details?></textarea>
              </div>
