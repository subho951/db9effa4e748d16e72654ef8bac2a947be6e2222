...
class LocationController extends Controller
{
    ...
    /* list */
        public function list(){
            ...
            $data['rows']                   = Location::where('status', '!=', 3)->orderBy('id', 'DESC')->get();
    ...
    /* edit */
        public function edit(Request $request, $id){
            ...
            $page_name                      = 'location.add-edit';
            $data['row']                    = Location::where($this->data['primary_key'], '=', $id)->first();
            if($request->isMethod('post')){
                $postData = $request->all();
                $rules = [
                    'name'                          => 'required',
                ...
                if($this->validate($request, $rules)){
                    ...
                    if(!$checkData){
                        ...
                        Location::where($this->data['primary_key'], '=', $id)->update($fields);
