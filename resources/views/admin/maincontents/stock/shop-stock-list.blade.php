              ...
              <tbody id="item-list">
                <?php if(count($rows)>0){ $sl=1; foreach($rows as $row){?>
                  <tr class="productList" id="product-row-<?=$row->id?>">
                    ...
                    <td><span id="stock-<?=$row->id?>"><?=$row->shop_stock?></span></td>
                    <td>
                      ...
                      <a href="<?=url('admin/stock/shop-stock-history/' . Helper::encoded($row->id))?>" target="_blank" class="btn btn-info btn-sm"><i class="fa fa-history"></i>&nbsp;HISTORY</a>
                    </td>
                  </tr>
                <?php } }?>
              </tbody>
