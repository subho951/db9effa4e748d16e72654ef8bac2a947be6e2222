...
class BrandController extends Controller
{
    ...
    /* list */
        public function list(){
            ...
            $data['rows']                   = Brand::where('status', '!=', 3)->orderBy('id', 'DESC')->get();
    ...
    /* edit */
        public function edit(Request $request, $id){
            ...
            $page_name                      = 'brand.add-edit';
            $data['row']                    = Brand::where($this->data['primary_key'], '=', $id)->first();
            if($request->isMethod('post')){
                $postData = $request->all();
                $rules = [
                    'name'                      => 'required',
                ...
                if($this->validate($request, $rules)){
                    ...
                    if(!$checkData){
                        ...
                        Brand::where($this->data['primary_key'], '=', $id)->update($fields);
