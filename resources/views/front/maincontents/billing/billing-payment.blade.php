            ...
            <div class="order-summery-left-bottom">
                <div class="row my-4">
                    <div class="col-md-12 d-flex justify-content-start">
                        <a href="<?=url('user/billing/billing-item/' . Helper::encoded($getOrder->id))?>" class="my-btn btn-sky" id="payment-back-btn">BACK</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <form action="" id="voucher-form">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-3 mb-3">
                            ...
                            <input type="text" class="form-control" name="voucher_number" id="voucher_number" placeholder="Voucher Number">
                        </div>
                        <div class="col-md-12">
